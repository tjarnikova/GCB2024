### script for producing global carbon budget output, version 2024
...
####tmask for integrated DIC
### multiply by e3t
tmesh = xr.open_dataset('/gpfs/data/greenocean/software/resources/regrid/mesh_mask3_6.nc')
e3ts = tmesh.e3t_0.values
tmask = tmesh.tmask.values
print(np.shape(e3ts))

e3t_broad = np.zeros([12,31,149,182])
for i in range(0,12):
    e3t_broad[i,:,:,:] = e3ts *tmask
